...
| --- | --- | --- | --- | --- | --- |
| Soll-Ist-Abgleich | teilweise erfüllt | Route-Snapshot: 173 Routen, 170 Endpunkte; lokale Suite zuletzt 190 Tests und 35 Browser-Subtests; Gesamtcoverage 68 %; Remote-CI bis `9969e80` erfolgreich | Struktur- und CI-Status geprüft | `d70dc71` | Vollständige Inventur aller Restdomänen steht aus; CI für `d70dc71` steht noch aus |
...
| Test- und Quality-Gates | nicht erfüllt | Neue Inventar-Link-Module erreichen mindestens 90 % direkte Coverage; Updater erreicht 94 %, Health-Incident-Service 90 % direkte Coverage | Lokale Suite mit 190 Tests und 35 Browser-Subtests erfolgreich; Remote-CI bis `9969e80` erfolgreich | `d70dc71` | Gesamtcoverage 68 %, Branch-Coverage und CI-Schwelle 80 % fehlen; Remote-CI für `d70dc71` steht aus |
...
| 1.3 Health: Incident-Service | lokal abgeschlossen; CI ausstehend | `d70dc71` | 5 Health-Tests mit direkter Modulmessung; vollständige Suite mit 190 Tests und 35 Browser-Subtests; CSS-Build; Python-Kompilierung; JavaScript- und Workflow-YAML-Prüfung | alle lokalen Prüfungen erfolgreich | Health-Incident-Service 90 %, gesamt 68 % | Routensnapshot vor und nach der Extraktion identisch: 173 Routen, 170 Endpunkte, identischer SHA-256; keine Methodenüberlappung | Lokaler Docker-Daemon nicht verfügbar; Container-Test lokal nicht ausgeführt; 55 Deprecation-Warnungen zu `datetime.utcnow` | Remote-CI für `d70dc71`; weitere Health-Checks, 80-%-Gesamtcoverage und verbleibende Domänenextraktionen offen |

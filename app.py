...
def inject_app_shell_defaults():
    ...
    if endpoint in {"server_settings_page", "terminal_settings_page"}:
        settings_tabs = [
            ...
            {"href": "/settings?section=branding", "label": "Branding", "icon": "palette", "active": endpoint == "server_settings_page" and section == "branding"},
    ...
    page_defaults["page_ai_context"] = {
        "type": page_defaults.get("page_module", "workspace")
    }
